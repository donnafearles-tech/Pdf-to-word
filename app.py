...
# =====================================================================
# 3. DETECCIÓN DE IDIOMA (VERSIÓN LINGÜÍSTA MEJORADA)
# =====================================================================
    ...
    try:
        ...
        respuesta = cliente.chat.completions.create(
            ...
            messages=[
                ...
                # Enviamos un bloque amplio de texto
        ...
        # Filtro extra de seguridad: quitar puntos o símbolos raros
        ...
        try:
            ...
            if exito_adobe:
                with st.spinner("🔍 Detectando idioma del documento..."):
                    ...
                    # 2. SALTO DE PORTADA: Ignoramos los primeros 10 párrafos 
                    # para saltar títulos, derechos de autor y transcripciones engañosas
